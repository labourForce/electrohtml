...
export default class checkoutStepVM{
    constructor(state){
        ...
        if( this.formValidate(event) ) {
            sendRequest({
                ...
                success: function(response){
                    ...
                    if(!data.error){
                        this.state.state.header.data.isLogin(true);
                        this.state.state.header.data.userName(data.user.username);
                        this.state.state.header.data.toPage('');
